...
public class TourAdapter extends RecyclerView.Adapter<TourAdapter.TourViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TourViewHolder holder,  int position) {
        ...
        holder.start.setText(tourDataList.get(position).getStart());
        holder.time.setText(tourDataList.get(position).getTime());
        Glide.with(context).
    ...
    public static final class TourViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView placeName, money, start, time;
        ...
        public TourViewHolder(@NonNull View itemView) {
            ...
            start = itemView.findViewById(R.id.start1);
