                    ...
                    mAuth.sendPasswordResetEmail(e_mail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                AlertDialog.Builder ok = new AlertDialog.Builder(Forgotpassword.this);
                                ...
                                Toast.makeText(Forgotpassword.this,"Email chưa được đăng ký tài khoản",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
